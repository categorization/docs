...
api: "GET https://categorization.dev/api/v1/scraper/profile"
...
curl --location --request GET 'https://categorization.dev/api/v1/scraper/profile?query=https://www.linkedin.com/in/williamhgates' \
