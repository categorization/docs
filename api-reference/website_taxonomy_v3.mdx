...
description: "IAB Categories are a taxonomy of content categories that can be used to categorize content. This taxonomy is used to categorize content for contextual targeting and brand safety."
---
...
Our APIs return IAB categories based on either version 3 (latest)

<Accordion title="Taxonomy v3">
    ...
    Books and Literature > Art and Photography
    ...
    Genres > Special Interest (Indie/Art House)

    Genres > Sports Radio

    Genres > Talk Radio

    Genres > Talk Radio > Public Radio
    ...
    Music > Adult Contemporary Music > Soft AC Music

    Music > Adult Contemporary Music > Urban AC Music
    ...
    Music > Rock Music > Album-oriented Rock

    Music > Rock Music > Alternative Rock

    Music > Rock Music > Classic Rock

    Music > Rock Music > Hard Rock

    Music > Rock Music > Soft Rock
    ...
    Shopping > Party Supplies and Decorations
    ...
    Video Gaming > Video Game Genres > Adult Video Games
    ...
    Video Gaming > Video Game Genres > Family Video Games

    Video Gaming > Video Game Genres > Horror Video Games
    ...
    Video Gaming > Video Game Genres > Racing Video Games
